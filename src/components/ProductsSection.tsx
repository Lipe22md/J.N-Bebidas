...
import caixaLata6Img from "@/assets/caixa de lata de itaipava.webp";
  ...
  return (
    <section id="produtos" className="py-16 bg-background">
      <div className="container mx-auto px-4">
        ...
        <CategorySection id="caixas-garrafas" titulo=" Caixas de Garrafas" descricao="Caixas de alta qualidade." produtos={caixasGarrafas} />
